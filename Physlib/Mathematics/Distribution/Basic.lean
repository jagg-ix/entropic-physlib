...
TODO "01-09-25-JTS" "In `Physlib/Mathematics/Distribution/Basic.lean`, for distributions
  `u : E →d[𝕜] F`, prove that the distributional derivative `fderivD 𝕜 u` commutes with
  integrals and sums. This may require first defining the integral of families of
  distributions, although it is expected this will follow from the definition of a
  distribution."
