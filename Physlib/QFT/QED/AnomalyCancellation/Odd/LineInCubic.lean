...
lemma lineInCubicPerm_swap {S : (PureU1 (2 * n.succ + 1)).LinSols}
  ...
  have h1 := line_in_cubic_symmPlane_symmPlane_shiftPlane (lineInCubicPerm_self LIC) g f h
  have h2 := line_in_cubic_symmPlane_symmPlane_shiftPlane (lineInCubicPerm_self (lineInCubicPerm_permute LIC
...
lemma lineInCubicPerm_last_cond {S : (PureU1 (2 * n.succ.succ+1)).LinSols}
  ...
  rw [symmPlane_symmPlane_shiftBasisAsCharges_accCube' g f hfg] at h1
